"""INT-G4D3-01~02：SignalService.evaluate_private_signals 持仓私有 SELL（V1.5-G G-4d-3）。

G-4d-1 把持仓私有 SELL 移出管线（见 test_int_p11_sg_04 断言管线不产 hard_stop_loss）；
G-4d-3 让每日 Job 按账户经 evaluate_private_signals 重新评估并通知。本文件验证同一持仓
浮亏场景下 evaluate_private_signals **确实**产出 hard_stop_loss 私有 SELL（不落库）。
"""
