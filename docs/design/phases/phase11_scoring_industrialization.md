...
|---|---|---|
| **candidate top 1% STRONG 数量** | 各 trade_date STRONG 数 ≈ **当日过滤后 universe × 1%**（相对口径；V1.0 实测 universe ~2400 → ≈ 24 只，落 [universe×0.75%, universe×1.25%] 即 PASS。原"≥30"假设全市场 ~3200，V1.0 过滤后 universe ~2400 已不适用——见 Phase 15 §15-3 RC 修订 / SDD §9.1）| composite_pct_in_market ≤ 0.01 ↔ composite_z ≥ 2.33 |
