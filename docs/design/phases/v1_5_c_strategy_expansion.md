...
> 版本：v0.14（C1 面板对比结论回写，2026-08-28）
...
- **重叠窗口必须修正**：前向窗口 20 交易日、逐日计算 → 相邻日收益区间共享 19/20，
  ...
  **只看朴素 t 会得出「三状态全部高度显著」的错误结论**。已据此登记 roadmap V1.5-K。
